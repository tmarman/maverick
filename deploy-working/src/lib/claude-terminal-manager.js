...
class ClaudeTerminalManager {
  constructor() {
    ...
    this.baseWorkingDir = '/tmp/maverick/terminals';
   ...
   * Save session history to file
   */
  async saveSessionHistory(sessionId) {
    const session = this.sessions.get(sessionId);
...
// Singleton instance
const claudeTerminalManager = new ClaudeTerminalManager();

module.exports = { claudeTerminalManager, ClaudeTerminalManager };