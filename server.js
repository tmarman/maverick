  ...
  createSession(sessionId, userId, options = {}) {
    ...
    if (!fs.existsSync(projectWorkingDir)) {
      ...
      try {
        ...
        const directories = [
          'project/docs',     // PRDs, specs, principles
...
\`\`\`
/project/          # Business documents and specifications
...
1. Review the PRD in \`/project/docs/PRD.md\`
2. Check design principles in \`/project/docs/design-principles.md\`
3. Review engineering standards in \`/project/docs/engineering-principles.md\`
...
- \`/project/docs/\` - Business documents (PRDs, specs, principles)
...
- Follow the design principles in \`/project/docs/design-principles.md\`
...
Adhere to engineering principles defined in \`/project/docs/engineering-principles.md\`:
...
- Update relevant documentation in \`/project/docs/\`
...
`)
        ...
        const projectDocsDir = `${projectWorkingDir}/project/docs`
...
`)
        ...
        const templatesDir = `${projectWorkingDir}/project/templates`
