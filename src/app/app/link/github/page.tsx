  ...
  const connectGitHub = async () => {
    try {
      ...
      if (preparationResponse.ok) {
        ...
        await signIn('github', { 
          callbackUrl: '/app/settings?tab=integrations&connected=github'
        })
      } else {
        ...
        <div className="text-center">
          ...
          {session?.user?.githubConnected ? (
            <div className="flex items-center justify-center gap-4">
              <Badge className="bg-background-secondary text-text-primary border border-border-standard px-4 py-2">
